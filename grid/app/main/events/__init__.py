...
routes = {
    ...
    STATIC_FL_EVENTS.HOST_FL_TRAINING: host_federated_training,
    STATIC_FL_EVENTS.AUTHENTICATE: authenticate,
    STATIC_FL_EVENTS.CYCLE_REQUEST: cycle_request,
    STATIC_FL_EVENTS.REPORT: report,
