...
parser.add_argument(
    ...
    type=int,
    help=
    "Port number of the socket server, e.g. --port=8777. Default is os.environ.get('GRID_PORT', None).",
...
parser.add_argument(
    ...
    type=str,
    help=
    "Grid node host, e.g. --host=0.0.0.0. Default is os.environ.get('GRID_HOST','0.0.0.0').",
...
if __name__ == "__main__":
    ...
    if args.start_local_db:
        ...
        app = create_app(node_id=args.id,
                         debug=False,
                         n_replica=args.num_replicas)
