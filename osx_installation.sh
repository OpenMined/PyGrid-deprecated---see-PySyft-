...
#
which -s go || echo "installing go..."; brew install go
which -s wget || echo "installing wget..."; brew install wget
which -s git || echo "installing git..."; brew install git
which -s python3 || echo "installing python3..."; brew install python3
